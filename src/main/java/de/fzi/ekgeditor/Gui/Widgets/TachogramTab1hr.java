...
public class TachogramTab1hr implements TriggerModelListner, ViewListener, MouseMoveListener{
	...
	private final int layerLength = 1 * 60 * 60 * 1; // in one layer, we have 12 min of
...
//	private double minValue = -5;
	...
	public TachogramTab1hr(TabFolder tabFolder){
		init(tabFolder);
	}
	...
	private void init(TabFolder tabFolder){
		...
		tachogramTabItem.setText("Tachogramm (1h)");
