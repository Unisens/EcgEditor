...
public class TachogramTab implements TriggerModelListner, ViewListener, MouseMoveListener{
	...
	private final int layerLength = 1 * 60 * 60; // in one layer, we have 12 min of
	private final int layers = 6; // we have 5 layers
...
//	private double minValue = -5;
	...
	private int[] availableAmplitudes = new int[]{10, 25, 50, 100, 200};
	...
	public TachogramTab(TabFolder tabFolder){
		init(tabFolder);
	}
	...
	private void init(TabFolder tabFolder){
		...
		tachogramTabItem.setText("Tachogramm (6h)");
