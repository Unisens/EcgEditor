...
public class Constants
{
	...
	public static final String aboutTitle = "�ber " + Programname;
	...
	public static final String unisensTitle = "�ber Unisens";
	public static final String unisensInfo = 
			  "UNISENS \n" 
			+ "Unisens ist ein universelles Datenformat f�r\n"
			+ "Multi-Sensor-Daten. Mehr Informationen �ber \n"
	...
	public static final String pleaseSelect = "- Signalklasse ausw�hlen -";
